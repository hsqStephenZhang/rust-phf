...
const HITS: &[&str] = &[
    "key00001", "key00002", "key00003", "key00001", "key00002", "key00003",
    "key00001", "key00002", "key00003", "key00001", "key00002", "key00003",
    "key00001", "key00002", "key00003", "key00001", "key00002", "key00003",
    "key00001", "key00002", "key00003", "key00001", "key00002", "key00003",
    "key00001", "key00002", "key00003", "key00001", "key00002", "key00003",
...
const MISSES: &[&str] = &[
    "mis00001", "mis00002", "mis00003", "mis00004", "mis00005", "mis00006",
    "mis00007", "mis00008", "mis00009", "mis00010", "mis00011", "mis00012",
    "mis00013", "mis00014", "mis00015", "mis00016", "mis00017", "mis00018",
    "mis00019", "mis00020", "mis00021", "mis00022", "mis00023", "mis00024",
    "mis00025", "mis00026", "mis00027", "mis00028", "mis00029", "mis00030",
    "mis00031", "mis00032",
];
...
fn bench_tiny(c: &mut Criterion) {
    bench_map(c, "tiny", TINY_MAP.disps.len(), |k| TINY_MAP.get(k).copied());
}

fn bench_small(c: &mut Criterion) {
    bench_map(c, "small", SMALL_MAP.disps.len(), |k| SMALL_MAP.get(k).copied());
}
...
fn bench_large(c: &mut Criterion) {
    bench_map(c, "large", LARGE_MAP.disps.len(), |k| LARGE_MAP.get(k).copied());
}
